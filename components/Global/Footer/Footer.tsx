      ...
      >
        ...
        <div className="drop-shadow lg:flex lg:items-center lg:justify-evenly">
          <div className="flex items-center justify-center p-6">
            ...
            <p className="p-3 logoFont text-xl font-bold text-gray-700">
          ...
          <div className="flex items-center justify-center p-6">
            ...
            {translate ? (
              <a
                className="p-3 text-xl logoFont font-bold text-gray-700"
  ...
  <div className="pt-0 md:hidden">
    ...
    <div className="drop-shadow lg:flex lg:items-center lg:justify-evenly">
      ...
      <div className="flex items-center justify-center p-6">
        ...
        <p className="p-3 text-xl font-bold text-gray-700 logoFont">Email Us</p>
      </div>
    </div>
  </div>
);
