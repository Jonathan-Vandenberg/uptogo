...
import { Construction, useConstructionCardQuery } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.construction.findUnique({
    where: {
      id: "6325dfa2aa4a7bfef376d213",
    },
  });
  return {
    props: { data },
