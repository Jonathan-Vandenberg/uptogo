...
import { Horticulture } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.horticulture.findUnique({
    where: {
      id: "6325deecaa4a7bfef376d1ff",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/trades/horticulture"
        />
