...
import { Hairdressing } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.hairdressing.findUnique({
    where: {
      id: "6325df36aa4a7bfef376d204",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/trades/hairdressing"
        />
