...
import { SportDevelopment } from "../../../../types";

interface IProps {
  data: SportDevelopment;
}

export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.sportDevelopment.findUnique({
    where: {
      id: "6325dec2aa4a7bfef376d1fa",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/trades/sport-development"
        />
