...
import { SupplyManagement } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.supplyManagement.findUnique({
    where: {
      id: "6325e19caa4a7bfef376d243",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/supply-management"
        />
