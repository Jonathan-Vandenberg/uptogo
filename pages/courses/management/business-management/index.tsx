...
import { BusinessManagement } from "../../../../types";

interface IProps {
  data: BusinessManagement;
}

export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.businessManagement.findUnique({
    where: {
      id: "6325e74daa4a7bfef376d265",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/business-management"
        />
