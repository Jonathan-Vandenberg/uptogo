...
import { HumanResources } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.humanResources.findUnique({
    where: {
      id: "6325e719aa4a7bfef376d260",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/human-resources"
        />
