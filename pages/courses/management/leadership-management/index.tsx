...
import { LeadershipManagement } from "../../../../types";

interface IProps {
  data: LeadershipManagement;
}

export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.leadershipManagement.findUnique({
    where: {
      id: "6325e160aa4a7bfef376d23d",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/leadership-management"
        />
