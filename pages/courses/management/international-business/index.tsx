...
import { IntlBusiness } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.intlBusiness.findUnique({
    where: {
      id: "6325e29baa4a7bfef376d255",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/international-business"
        />
      ...
      <div className="mx-auto container md:pt-12 pb-8">
        <CoursesMainPage
          data={data}
