...
import { AgribusinessManagement } from "../../../../types";

interface IProps {
  data: AgribusinessManagement;
}

export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.agribusinessManagement.findUnique({
    where: {
      id: "6325e1edaa4a7bfef376d249",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/management/agriculture-business-management"
        />
