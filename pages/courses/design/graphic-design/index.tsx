...
import { GraphicDesign, useGraphicDesignCardQuery } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.graphicDesign.findUnique({
    where: {
      id: "63247d6cef7048971301fe21",
    },
  });
  return {
    props: { data },
