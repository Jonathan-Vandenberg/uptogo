...
import { FashionDesign } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.fashionDesign.findUnique({
    where: {
      id: "63247df8ef7048971301fe2d",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/design/fashion-design"
        />
