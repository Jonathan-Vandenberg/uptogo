...
import { PublicHealth } from "../../../../types";
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await prisma?.publicHealth.findUnique({
    where: {
      id: "632570deaa4a7bfef376d196",
    },
  });
  return {
    props: { data },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://www.uptogo.org/courses/health/public-health"
        />
